...
# Load data
tra_df = pd.read_excel('kpmg_dataset/Streamlit/kpmg_cleaned_dataset.xlsx',sheet_name="transactions")
cdg_df = pd.read_excel('kpmg_dataset/Streamlit/kpmg_cleaned_dataset.xlsx',sheet_name="customer_demographic")
cad_df = pd.read_excel('kpmg_dataset/Streamlit/kpmg_cleaned_dataset.xlsx',sheet_name="customer_address")
