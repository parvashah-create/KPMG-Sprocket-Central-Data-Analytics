...
st.plotly_chart(fig)
st.markdown("\nThe graph is a representation of the relationship between the profit and the product line and product size of a certain company.")
...
st.plotly_chart(fig)
st.markdown("This graph appears to be a histogram comparing the online_order and revenue (represented by list_price) and profit of a company")
...
st.plotly_chart(fig)
st.markdown("\nThis graph shows profit and customer job categories with different wealth segment. By comparing the box plots for different job industry categories and wealth segment, we can make inferences about which job industries tend to be more profitable and which wealth segments tend to have higher profits.")
...
st.plotly_chart(fig)
st.markdown("\nThe above graph indicates the revenue (List Price) segment and customer wealth segment with different job category, purchasing the bikes with listed price")


# profits by product line pie chart
fig = px.pie(tra_cdg_df, values='profit', names='wealth_segment', title="profit % by wealth_segment")
st.plotly_chart(fig)
st.markdown("\n Pie chart shows the profit made by customer waelth segment in percentage.")
